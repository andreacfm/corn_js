...
FatPopcorn.prototype.currentLabel = function() {
	return $('.fatpopcorn').attr('data-label');
};
...
FatPopcorn.decorateContainerWithHtml = function() {
	...
	function _html() {
	    return '<div class="fatpopcorn"><div class="popcorn-body"><div class="header"><ul><li class="stream-tab active"><div>stream</div></li>' +
		 ...
		 '<div class="attachment"><h1>Allegati</h1><a href="#">Inserisci</a></div><div class="info"><h1>Info</h1><p>Lorem ipsum...</p></div></div></div><div class="popcorn-tail"></div></div>';
	};
...
FatPopcorn.bindRemoteEvents = function() {
	$('.fatpopcorn #send_note').on('click', function() {
		
		$('.fatpopcorn form#notes_form').submitWithAjax();
	});
};
FatPopcorn.callRemote = function() {
};
(function($) {
	$.fn.submitWithAjax = function() {
	    this.submit(function() { $.post(this.action, $(this).serialize(), null, "script"); return false; });
	    return this; 
	};
